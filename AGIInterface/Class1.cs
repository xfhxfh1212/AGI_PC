...
namespace AGIInterface
{
    ...
    public class Class1
    {
        ...
        ///把设备的ACK信息发送给搜索窗口
        /// </summary>
        public delegate void DeviceSendACKToCellScan(object sender, CustomDataEvtArg e);
        /// <summary>
        ///事件
        /// </summary>
        public event DeviceSendACKToCellScan SendACKToCellScanEvent;
        ...
        /// 发送ACK到搜索窗口
        /// </summary>
        public void SendACKToCellScan(object sender, CustomDataEvtArg e)
        {
            if (SendACKToCellScanEvent != null)
                SendACKToCellScanEvent(sender, e);
        }
        ...
        #region 测向开始
        public delegate void OrientationFidingStartHandler();
        public event OrientationFidingStartHandler OrientationFidingStartEvent;
        public void OrientationFidingStart()
        {
            if (OrientationFidingStartEvent != null)
                OrientationFidingStartEvent();
        }
        #endregion
        /// <summary>
        /// 停止测试事件
