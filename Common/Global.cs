...
namespace COM.ZCTT.AGI.Common
{
    public class Global
    {
        ...
        /// <returns></returns>
        public static double EARFCNToFreq(int iEARFCN)
        {
            //E-UTRA Operating Band	FDL_low (MHz)	NOffs-DL	Range of NDL	FUL_low (MHz)	NOffs-UL	Range of NUL
            ...
            int rowOffset = 1;
            if (iEARFCN >= 37550 && iEARFCN <= 37749)
                return Convert.ToDouble((iEARFCN - FreqEARFCNTable[0, rowOffset + 1] + FreqEARFCNTable[0, rowOffset] * 10) / 10.0);
            else if (iEARFCN >= 37750 && iEARFCN <= 38249)
                return Convert.ToDouble((iEARFCN - FreqEARFCNTable[1, rowOffset + 1] + FreqEARFCNTable[1, rowOffset] * 10) / 10.0);
            else if (iEARFCN >= 38250 && iEARFCN <= 38649)
                return Convert.ToDouble((iEARFCN - FreqEARFCNTable[2, rowOffset + 1] + FreqEARFCNTable[2, rowOffset] * 10) / 10.0);
            else if (iEARFCN >= 38650 && iEARFCN <= 39649)
                return Convert.ToDouble((iEARFCN - FreqEARFCNTable[3, rowOffset + 1] + FreqEARFCNTable[3, rowOffset] * 10) / 10.0);
            else if (iEARFCN >= 39650 && iEARFCN <= 41589)
                return Convert.ToDouble((iEARFCN - FreqEARFCNTable[4, rowOffset + 1] + FreqEARFCNTable[4, rowOffset] * 10) / 10.0);
            else if (iEARFCN >= 41590 && iEARFCN <= 43589)
                return Convert.ToDouble((iEARFCN - FreqEARFCNTable[5, rowOffset + 1] + FreqEARFCNTable[5, rowOffset] * 10) / 10.0);
            else if (iEARFCN >= 43590 && iEARFCN <= 45589)
                return Convert.ToDouble((iEARFCN - FreqEARFCNTable[6, rowOffset + 1] + FreqEARFCNTable[6, rowOffset] * 10) / 10.0);
            else if (iEARFCN >= 0 && iEARFCN <= 599)
                return Convert.ToDouble((iEARFCN - FreqEARFCNTable[7, rowOffset + 1] + FreqEARFCNTable[7, rowOffset] * 10) / 10.0);
            else if (iEARFCN >= 1200 && iEARFCN <= 1949)
                return Convert.ToDouble((iEARFCN - FreqEARFCNTable[8, rowOffset + 1] + FreqEARFCNTable[8, rowOffset] * 10) / 10.0);
            else
                return -1;
        }
        public static int EARFCNToBand(int iEARFCN)
        {
            if (iEARFCN >= 37550 && iEARFCN <= 37749)
                return 37;
            else if (iEARFCN >= 37750 && iEARFCN <= 38249)
        ...
        public static string EARFCNToLteMode(int iEARFCN)
        {
            if (iEARFCN >= 36000 && iEARFCN <= 45589)
                return "TDD";
            else if (iEARFCN >= 0 && iEARFCN <= 8689)
                return "FDD";
            else
                return "";
        }
